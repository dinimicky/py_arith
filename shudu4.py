...
class Shudu(object):
    ...
    defaultPositions = [(i % 9, i //9, i % 9 // 3 + i//9//3*3)for i in range(81)]
    defaultRows = [[i*9+j for j in range(9)]for i in range(9)]
    defaultCols = [[i+j*9 for j in range(9)]for i in range(9)]
